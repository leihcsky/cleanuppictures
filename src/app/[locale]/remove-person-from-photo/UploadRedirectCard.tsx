...
export default function UploadRedirectCard({ locale }) {
  ...
  const sampleUrls = [
    publicCdnUrl("remove-people/sample1-remove-people-before.jpg"),
    publicCdnUrl("remove-people/sample2-remove-people-before.jpg"),
    publicCdnUrl("remove-people/sample3-remove-people-before.jpg")
  ];
