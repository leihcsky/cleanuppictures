...
export default function UploadRedirectCard({ locale }) {
  ...
  const sampleUrls = [
    publicCdnUrl("remove-text/sample1-remove-text-before.jpg"),
    publicCdnUrl("remove-text/sample2-remove-text-before.jpg"),
    publicCdnUrl("remove-text/sample3-remove-text-before.jpg")
  ];
