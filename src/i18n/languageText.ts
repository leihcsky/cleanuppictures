...
export const getRemoveShadowPageText = async () => {
  ...
  return {
    ...
    sample4Title: tPageUnsafe('sample4Title'),
    sample4Desc: tPageUnsafe('sample4Desc'),
...
export const getRemoveGlarePageText = async () => {
  const tPage = await getTranslations('RemoveGlarePage');
  const tPageUnsafe = tPage as (key: string) => string;
  return {
    title: tPage('title'),
    h1: tPage('h1'),
    ...
    sample3Title: tPage('sample3Title'),
    sample3Desc: tPage('sample3Desc'),
    sample4Title: tPage('sample4Title'),
    sample4Desc: tPage('sample4Desc'),
    seeSamplesBtn: tPage('seeSamplesBtn'),
    howToUseBtn: tPage('howToUseBtn'),
    settingStrengthDesc: tPageUnsafe('settingStrengthDesc'),
    settingAggressiveDesc: tPageUnsafe('settingAggressiveDesc'),
    sampleSettingsLabel: tPageUnsafe('sampleSettingsLabel'),
    trySampleBtn: tPageUnsafe('trySampleBtn'),
    howToUseTitle: tPageUnsafe('howToUseTitle'),
    howToUseDesc: tPageUnsafe('howToUseDesc'),
    step1Title: tPageUnsafe('step1Title'),
    step1Desc: tPageUnsafe('step1Desc'),
    step2Title: tPageUnsafe('step2Title'),
    step2Desc: tPageUnsafe('step2Desc'),
    step3Title: tPageUnsafe('step3Title'),
    step3Desc: tPageUnsafe('step3Desc'),
    promptMask: tPage('promptMask'),
    actionButton: tPageUnsafe('actionButton'),
    processingLabel: tPageUnsafe('processingLabel')
  }
}
...
export const getRemoveColorPageText = async () => {
  ...
  return {
    ...
    description: tPage('description'),
    aboutDesc: tPage('aboutDesc'),
    settingsTitle: tPage('settingsTitle'),
    settingToleranceTitle: tPage('settingToleranceTitle'),
    settingToleranceDesc: tPage('settingToleranceDesc'),
    settingRefineTitle: tPage('settingRefineTitle'),
    settingRefineDesc: tPage('settingRefineDesc'),
    settingAutoTitle: tPage('settingAutoTitle'),
    settingAutoDesc: tPage('settingAutoDesc'),
    settingAutoRefineTitle: tPage('settingAutoRefineTitle'),
    settingAutoRefineDesc: tPage('settingAutoRefineDesc'),
    featureTitle: tPage('featureTitle'),
    featureDesc: tPage('featureDesc'),
    useCasesTitle: tPage('useCasesTitle'),
    useCasesDesc: tPage('useCasesDesc'),
    faq1Q: tPage('faq1Q'),
    faq1A: tPage('faq1A'),
    faq2Q: tPage('faq2Q'),
    faq2A: tPage('faq2A'),
    ...
    sampleDesc: tPage('sampleDesc'),
    sampleSettingsLabel: tPage('sampleSettingsLabel'),
    sampleTryButton: tPage('sampleTryButton'),
    sample1Title: tPage('sample1Title'),
    sample1Desc: tPage('sample1Desc'),
    sample2Title: tPage('sample2Title'),
    sample2Desc: tPage('sample2Desc'),
